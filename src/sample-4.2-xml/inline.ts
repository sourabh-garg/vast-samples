const InlineLinearTagXMLString =
    ...
    '              <Tracking event="progress" offset="00:00:10"><![CDATA[https://example.com/tracking/progress-10]]></Tracking>\n' +
...
const InlineCompanionXMLString =
    ...
    '                        <Verification vendor="iabtechlab.com-omid">\n' +
    '                            <JavaScriptResource apiFramework="omid" browserOptional="true">\n' +
    '                                <![CDATA[https://videoassets41.blob.core.windows.net/javascript/omid-validation-verification-script-v1-org.js]]></JavaScriptResource>\n' +
    '                            <TrackingEvents>\n' +
    '                                <Tracking event="verificationNotExecuted"><![CDATA[http://example.com]]></Tracking>\n' +
    '                            </TrackingEvents>\n' +
    '                            <VerificationParameters><![CDATA[iabtechlab-inmobi]]></VerificationParameters>\n' +
    '                        </Verification>\n' +
    '                    </AdVerifications>\n' +
    '                </Extension>\n' +
    '            </Extensions>\n' +
...
export const InlineXMLString_4_2 = {
